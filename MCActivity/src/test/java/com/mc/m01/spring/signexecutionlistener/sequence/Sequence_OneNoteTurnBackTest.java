...
public class Sequence_OneNoteTurnBackTest extends SpringAbstractTestBase {
    ...
    public void baseTest() {
		...
		repositoryService.createDeployment().addClasspathResource("diagrams/201801/sequence/ACT_TEST_Sequence_OneNoteTurnBack.bpmn").deploy();
    }
    ...
    public void testOneNoteTurnBack_FirstTrunBack_SencodAgree() throws InterruptedException {
        ...
        String procInstId = runtimeService.startProcessInstanceByKey("ACT_TEST_Sequence_OneNoteTurnBack", startVariable).getId();
